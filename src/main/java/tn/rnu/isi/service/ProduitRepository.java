...
public interface ProduitRepository extends CrudRepository <Produit, Long>{
 ...
 //repository = SQL reperesentation of ProduitService interface 
	Produit findByIdProduit(Long idProduit);
	
	 
	List<Produit> findAll(); //CrudRepo function that returns all profucts
	
	Produit save (Produit produit); // CrudRepo function that saves (INSERT) or Updates an object
